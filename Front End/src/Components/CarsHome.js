        ...
        <div className="w-full">
            ...
            <div className='hidden lg:block'>
                <div className="w-full grid grid-cols-2 px-16 py-4 ">
                    <div style={{ backgroundColor: "#54a6ff" }} className="  mr-4 rounded-lg px-4 py-6 max-h-60 ">
                        ...
                        <div className='flex justify-end items-center'><img src={car2} alt=" Car" className="  lg:max-w-lg"></img></div>
                    </div>

                    <div style={{ backgroundColor: "#546fff", maxHeight: "290px" }} className=" mr-4 rounded-lg px-4 py-6 ">
                        ...
                        <div className='flex justify-end items-center'><img src={car1} alt=" Car" className="lg:max-w-lg"></img></div>
                    </div>
                </div>
            </div>
