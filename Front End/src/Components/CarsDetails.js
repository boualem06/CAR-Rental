...
const CartDetails = () => {
    ...
    return (
        <div style={{ backgroundColor: "#f3f4f8" }} className="w-full flex lg:flex-row flex-col px-4 py-4">
            ...
            <div className="  px-4  py-4 rounded-lg  lg:grid lg:grid-rows-4 bg-white ">
                <div className='mb-8 lg:mb-0'>
                    <h1 className='text-2xl font-bold'>Porch Boxer </h1>
                    <Rating name="read-only" value={3} readOnly />
                </div>
                <p className='mb-8 lg:mb-0'>The Porsche Boxster is a mid-engine two-seater roadster. It was Porsche's first road vehicle to be originally designed as a roadster since the 914. The first-generation Boxster (the 986) was introduced in late 1996; it was powered by a 2.5-litre flat six-cylinder engine.</p>
                <div className='grid grid-cols-4 mb-8 lg:mb-0'>
                    <div>
